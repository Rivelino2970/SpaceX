...
# Make a request to the API and get the response content
json_data = response.json()

# Normalize the JSON data and turn it into a Pandas dataframe
...
# Filter the data dataframe to only keep Falcon 9 launches
